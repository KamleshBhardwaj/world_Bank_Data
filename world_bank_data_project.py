# -*- coding: utf-8 -*-
"""World Bank Data project.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1hBcZkprm_ewRynuMP4TRRcbRupHoLAFK
"""
...
Country = pd.read_csv("/content/drive/MyDrive/Metadata_Country.csv")
Population = pd.read_csv("/content/drive/MyDrive/country_population.csv")
Fertility = pd.read_csv("/content/drive/MyDrive/fertility_rate.csv")
Life_Expectancy = pd.read_csv("/content/drive/MyDrive/life_expectancy.csv")
...
plt.bar(avg_fertility_rate['Region'], avg_fertility_rate['Fertility'], color='green')
